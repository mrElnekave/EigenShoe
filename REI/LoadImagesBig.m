function [IMAGE_DIM, IMAGE_SIZE, num_shoes, Shoes, Lookup] = LoadImagesBig(names, pics_per_shoe, show)
    ...
    %
    %   Syntax:
    %       [IMAGE_DIM, IMAGE_SIZE, num_shoes, Shoes, Lookup] = LoadImagesBig( names );
    %       [IMAGE_DIM, IMAGE_SIZE, num_shoes, Shoes, Lookup] = LoadImagesBig( names , 3);
    %       [IMAGE_DIM, IMAGE_SIZE, num_shoes, Shoes, Lookup] = LoadImagesBig( names , 3, true);
    %
    %   Description:
    %       LoadImages() - loads and scales images
    %
